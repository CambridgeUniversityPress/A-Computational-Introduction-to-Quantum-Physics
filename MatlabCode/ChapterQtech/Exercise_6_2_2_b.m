...
for n1 = 2:Len;
 ...
 for n2 = 1:(n1-1);
   ...
   % Difference in L quantum number
   DeltaL = abs(Data_eV(n1, 2) - Data_eV(n2, 2));
   % Difference in total spin
   SpinDiff = Data_eV(n1, 1) - Data_eV(n2, 1);
   
   % Check selection rules and visible spectrum
