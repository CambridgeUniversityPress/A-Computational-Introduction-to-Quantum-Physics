...
% 
% The simulation progresses until the probability of the particle to 
% remain on the grid passes 0.5 %. (This limit can be changed.)
%
...
Ham = Tmat + diag(Vpot(x)) - 1i*diag(Vabs(x));  % Hamiltonian
...
% Plot potential
plot(x, 0.4*Vpot(x)/V0*MaxValPsi0, 'b-', 'linewidth', 2)
